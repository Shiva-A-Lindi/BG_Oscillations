...
G_dict = {(name1, name1) : np.array( [-g]* (n))
         
        }

filename = 'Proto_Proto_N_1000_T_2000_' + str(n) + '_pts_' + str(n_run) + '_runs' + '.pkl'
