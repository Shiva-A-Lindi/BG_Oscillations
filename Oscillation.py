...
proto_shift = 0
sheet_name_extra = ''
time_shift_dict = {'MSNs': 0 ,'STN': -7.5, 'Arky': 0, 'Proto': -7.5}
...
ax.set_xlim(-15, 90)
save_pdf_png(fig, os.path.join(path, 'D2_trans_stim_onto_Proto' + str(n_run) + '_run_compared_with_experiment_' + filename.split('.')[0].split('_')[-1] ), size = (5,3))
