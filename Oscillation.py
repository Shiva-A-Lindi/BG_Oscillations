...
mean_AHP_Proto = ( (-67.3 * 14) + (-66.5 * 5) ) /(14 + 5)
SD_AHP_Proto = np.sqrt( 
...
# 					'u_rest': {'mean': -59, 'var': 0.4, 'truncmin': -1000, 'truncmax': -45},  # Paz et al. 2005 (till Dec 1st)
                    ...
                    'u_rest': {'mean': -60.3, 'var': 0.8, 'truncmin': -76, 'truncmax': -52},  # Beurrier et al. 1999
					'membrane_time_constant':{'mean': 5.13,'var':0.97, 'truncmin': 0.5, 'truncmax': 100}, # Paz et al. 2005
                    'spike_thresh': {'mean':-41.4,'var':0.7}}} # Beurrier et al. 1999 Spike thresh truc(-54, -34)
# 					'membrane_time_constant':{'mean': 5.13,'var':0.97, 'truncmin': 0.5, 'truncmax': 100},'spike_thresh': {'mean':-50.8,'var':0.5}}} # Paz et al 2005 
...
filename = name1 + '_N_1000_T_5000_' + str(n) + '_pts_' + str(n_run) + '_runs' + '_dt_' + str(dt).replace('.', '-') + '_' + noise_method + '.pkl'
...
if save_figures:
 	save_figs(figs, nuclei_dict, G_dict, noise_variance, path, fft_method, pre_prefix = [name1 + '_']*4, s = s)
...
filename = os.path.join(path, 'Beta_power','Proto_N_1000_T_5000_4_pts_8_runs_dt_0-1_Ornstein-Uhlenbeck.pkl' )
inset_props = [0.6, 0.3, 0.35, 0.35]
name_list = ['Proto']
n_g_list = np.arange(4)

filename = os.path.join(path, 'Beta_power','STN_N_1000_T_5000_3_pts_8_runs_dt_0-1_Ornstein-Uhlenbeck.pkl' )
inset_props = [0.6, 0.3, 0.35, 0.35]
name_list = ['STN']
